...
import { setupEmailAction } from "@/actions/auth";
...
export default function SetupEmailPage() {
  const [state, formAction, isPending] = useActionState(setupEmailAction, initialState);
    ...
    >
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          >
            <Mail size={48} fill="rgba(232,0,45,0.2)" color="#E8002D" />
          </motion.div>
          ...
          <p style={{ color: "rgba(255,255,255,0.7)", fontSize: 14 }}>
            Güvenliğiniz için lütfen hesabınıza bir e-posta adresi tanımlayın. Doğrulama kodu bu adrese gönderilecektir.
          </p>
        </div>
        ...
        <form action={formAction} className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <input
              ...
              required
              className="w-full text-center custom-placeholder"
              style={{
                paddingTop: 16,
                paddingBottom: 16,
